...
subtitle: "ESM 244 - Assignment 3 Task 3"
...
kable(merced_wordcount, caption = "Table 1. Unique non-stopwords in each section of Resilient Merced") %>%
  kable_styling(width = 5, bootstrap_options = c("striped", "hover"))
```
...
afinn_plot <- ggplot(data = afinn_means,
  ...
  labs(y="Average Afinn Score", x = "Section") +
  coord_flip() +
  theme_light()
...
ggplot(data = bing_counts, aes(x = sentiment, y = n)) +
  ...
  labs(x="Bing Score", y = "Number of Mentions", fill = "Sentiment") +
  theme_light()
